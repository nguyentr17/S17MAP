...
>>>>>>> Stashed changes
```
## Performing t-test: The sample code performed a two-sample t-test on the overall datset. You should modify the code accordingly to test your given dataset.
```{r}
