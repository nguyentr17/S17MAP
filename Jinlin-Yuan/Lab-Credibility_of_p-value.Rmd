...
In order to better understand the meaning of a p-value, we are going to compare the p-values of multiple studies that all conducted similar tests.
...
*The link to the game: (http://web.grinnell.edu/individuals/kuipers/stat2labs/Perfection.html). *
...
## Part One: Conducting hypothesis test on the overall dataset

We will start our analysis by running a two-sample t-test on the entire sample. The following code will import your data and conduct test.
...
*Recall on one of the assumptions we made before conducting a two-sample t-test is the equal variance for both groups. 
...
////////////////////interval of possible p-value range 
even when the H1 are 
