...
bwplot( TimeUsed ~ level_gender, data = tangram[tangram$level_gender == "F"|tangram$level_gender == "M",], main="") 
```
...
ggplot(stem_tangram_statsgame[stem_tangram_statsgame$PuzzleName %in% head(stem_tangram_count$PuzzleName,5),], aes(fill = level_stem, y = TimeUsed, x = PuzzleName)) +
  geom_bar(position = "dodge", stat = "identity")
```
